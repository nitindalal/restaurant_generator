...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { delivery_time: @menu_item.delivery_time, item_name: @menu_item.item_name, price: @menu_item.price, sensitivity_cd: @menu_item.sensitivity_cd }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { delivery_time: @menu_item.delivery_time, item_name: @menu_item.item_name, price: @menu_item.price, sensitivity_cd: @menu_item.sensitivity_cd }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
